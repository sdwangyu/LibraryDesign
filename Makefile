...
# Template: app
# Command: C:\qt\Qt5.9.3\5.9.3\mingw53_32\bin\qmake.exe -o Makefile LibraryDesign.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: LibraryDesign.pro ../../../qt/Qt5.9.3/5.9.3/mingw53_32/mkspecs/win32-g++/qmake.conf ../../../qt/Qt5.9.3/5.9.3/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile LibraryDesign.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
